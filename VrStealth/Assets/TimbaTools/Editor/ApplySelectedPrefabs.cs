...
namespace TimbaTools
{
    ...
    public class ApplySelectedPrefabs
    {
        ...
        [MenuItem("Timba/Apply Changes To Selected Prefabs", false, 100)]
        private static void ApplyPrefabs()
        {
            SearchPrefabConnections(ApplyToSelectedPrefabs);
        }

        [MenuItem("Timba/Revert Changes Of Selected Prefabs", false, 100)]
        private static void ResetPrefabs()
        {
            SearchPrefabConnections(RevertToSelectedPrefabs);
        }

        [MenuItem("Timba/Apply Changes To Selected Prefabs", true)]
        [MenuItem("Timba/Revert Changes Of Selected Prefabs", true)]
